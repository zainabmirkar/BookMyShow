...
// cast
import Cast from '../components/Crew/Cast.component';
   ...
   const {id} = useParams();
    ...
    return (
        <>
                ...
                <div className="my-8">
                    ...
                    <div className="flex items-start gap-2 bg-yellow-100 p-3 border-2 border-yellow-400 border-dashed rounded-md">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <p className="text-gray-600">Buy it for just 99 in our limited period offer and get INR 75 off on each</p>
                        </div>
                    </div>
                </div>
                    </div>
            ...
            <PosterSlider
            config={settings}
             images={SimilarMovies} title="You Might Also Like" isDark={false}/>
            </div>
            ...
            <PosterSlider
            config={settings}
             images={recommended} title="BMS XCLUSIV" isDark={false}/>
            </div>
