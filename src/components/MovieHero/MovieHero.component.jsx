        ...
        <>
            <div>
                ...
                <div className="absolute w-full h-56 bg-opacity-50 bg-black z-10 bottom-0"/>
                    {/* contents will be visible for small screen */}
                ...
                <MovieInfo/>
                     ...
                     {/* contents will be visible for medium screen */}
                     <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`}
                ...
                />
                <div className=" absolute z-30 left-24 top-32 flex items-center gap-10">
                     <div  className=" w-64 h-96  ">
                     {/* contents will be visible for large screen */}
                     <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`}
