...
const NavLg = () =>{
    ...
    <div className="w-full flex items-center gap-3 bg-white px-3 py-2 rounded-md">
         ...
         <span className="text-gray-400 text-xs flex items-center hover:text-white cursor-pointer">Mumbai <BiChevronDown/></span>
         <button className="bg-red-500 text-white  w-24  rounded-md text-sm">Sign in</button>
